        ...
        <footer class="border-t border-white/5 bg-[#050508]" role="contentinfo">
            <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
                ...
                <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4 lg:gap-12">
                    ...
                    <div class="sm:col-span-2 lg:col-span-1">
                        ...
                        <div class="flex gap-4">
                            ...
                            <a @click.prevent="openSocialMedia('Instagram')" href="https://instagram.com/gems" target="_blank" rel="noopener noreferrer" class="cursor-pointer text-gray-400 transition-colors hover:text-purple-400 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 focus:ring-offset-[#050508] focus:rounded" aria-label="Follow us on Instagram">
                            ...
                            <a @click.prevent="openSocialMedia('Pinterest')" href="https://pinterest.com/gems" target="_blank" rel="noopener noreferrer" class="cursor-pointer text-gray-400 transition-colors hover:text-cyan-400 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-[#050508] focus:rounded" aria-label="Follow us on Pinterest">
                    ...
                    <!-- Collections -->
                    <div>
                        <h2 class="mb-4 bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-xs tracking-[0.2em] text-transparent sm:mb-6">COLLECTIONS</h2>
                        <ul class="space-y-2 text-sm text-gray-400 sm:space-y-3">
                            <li><a @click.prevent="viewCollection('Round Cut')" href="/collection" aria-label="View Round Cut diamond collection" class="cursor-pointer text-gray-400 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-[#050508] focus:rounded">Round Cut</a></li>
                            <li><a @click.prevent="viewCollection('Pear Cut')" href="/collection" aria-label="View Pear Cut diamond collection" class="cursor-pointer text-gray-400 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-[#050508] focus:rounded">Pear Cut</a></li>
                            <li><a @click.prevent="viewCollection('Oval Cut')" href="/collection" aria-label="View Oval Cut diamond collection" class="cursor-pointer text-gray-400 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-[#050508] focus:rounded">Oval Cut</a></li>
                            <li><a @click.prevent="viewCollection('Emerald Cut')" href="/collection" aria-label="View Emerald Cut diamond collection" class="cursor-pointer text-gray-400 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-[#050508] focus:rounded">Emerald Cut</a></li>
                        </ul>
                    </div>

                    <!-- Services -->
                    <div>
                        <h2 class="mb-4 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-xs tracking-[0.2em] text-transparent sm:mb-6">SERVICES</h2>
                        <ul class="space-y-2 text-sm text-gray-400 sm:space-y-3">
                            <li><a @click.prevent="viewService('Private Consultations')" href="/contact" aria-label="Book a private consultation" class="cursor-pointer text-gray-400 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 focus:ring-offset-[#050508] focus:rounded">Private Consultations</a></li>
                            <li><a @click.prevent="viewService('Diamond Education')" href="/blog" aria-label="Learn about diamonds" class="cursor-pointer text-gray-400 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 focus:ring-offset-[#050508] focus:rounded">Diamond Education</a></li>
                            <li><a @click.prevent="viewService('Cleaning & Care')" href="/contact" aria-label="Learn about cleaning and care" class="cursor-pointer text-gray-400 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 focus:ring-offset-[#050508] focus:rounded">Cleaning & Care</a></li>
                            <li><a @click.prevent="viewService('Insurance Appraisals')" href="/contact" aria-label="Get insurance appraisals" class="cursor-pointer text-gray-400 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 focus:ring-offset-[#050508] focus:rounded">Insurance Appraisals</a></li>
                            <li><RouterLink to="/blog" aria-label="Read our blog" class="text-gray-400 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 focus:ring-offset-[#050508] focus:rounded">Blog</RouterLink></li>
                        </ul>
                    </div>

                    <!-- Contact -->
                    <div>
                        <h2 class="mb-4 bg-gradient-to-r from-pink-400 to-cyan-400 bg-clip-text text-xs tracking-[0.2em] text-transparent sm:mb-6">VISIT US</h2>
                        <address class="space-y-2 text-sm not-italic text-gray-400 sm:space-y-3">
                ...
                <div class="mt-10 flex flex-col items-center justify-between gap-4 border-t border-white/5 pt-8 sm:mt-12 sm:flex-row">
                    <p class="text-xs text-gray-400">&copy; 2025 GEMS. All rights reserved.</p>
                    <nav class="flex flex-wrap justify-center gap-4 text-xs text-gray-400 sm:gap-6" aria-label="Footer legal links">
                        <a @click.prevent="viewPolicy('Privacy Policy')" href="/contact" aria-label="View privacy policy" class="cursor-pointer text-gray-400 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-[#050508] focus:rounded">Privacy Policy</a>
                        <a @click.prevent="viewPolicy('Terms of Service')" href="/contact" aria-label="View terms of service" class="cursor-pointer text-gray-400 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-[#050508] focus:rounded">Terms of Service</a>
                        <a @click.prevent="viewPolicy('Cookie Policy')" href="/contact" aria-label="View cookie policy" class="cursor-pointer text-gray-400 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-[#050508] focus:rounded">Cookie Policy</a>
                    </nav>
                </div>
            </div>
        </footer>
